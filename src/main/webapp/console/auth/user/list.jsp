...
if ("GET".equals(request.getMethod())){
	if (session.getAttribute("userSearch")!=null){
		user=(AdminUser)session.getAttribute("userSearch");
	}
}
...
String[][] aList=dao.getList(user,(lCurrentPage-1)*lPageSize+1,lPageSize);
  ...
  <TABLE WIDTH="98%" CELLPADDING="0" CELLSPACING="0" BORDER="0" CLASS="wasPortlet">
	...
	<TR>   
		<TD CLASS="wpsPortletArea" COLSPAN="3" >
    		<h1 id="title-bread-crumb">User list</h1>
 			<p class="instruction-text">Use this page to show the user list. You can set filter to shorten the list. </p>
 				...
 				<form action="<%=request.getRequestURI()%>" method=post name="frmAction" id="frmAction">
					    	...
					    	<TD CLASS="column-filter-expanded" COLSPAN=7>
					           ...
					           <table width="10%" border="0">
								 <TR valign="top">
								     ...
								     <TD NOWRAP CLASS="column-filter-expanded"  scope="row" valign="top"width="80%" ><INPUT id="filterItem" name="name" size="60"  value="<%=user.getName()%>" class="textEntryRequired" ></TD>
								   </TR>
								    <TR>
								        <td NOWRAP CLASS="column-filter-expanded"  scope="row" valign="top"width="20%" >Full Name:</TD>
								        <TD NOWRAP CLASS="column-filter-expanded"  scope="row" valign="top"width="80%" ><INPUT id="filterItem" name="fullName" size="60" value="<%=user.getFullName()%>" class="textEntry"></TD>
								   </TR>
					...
					<TABLE BORDER="0" CELLPADDING="3" CELLSPACING="1" WIDTH="100%" SUMMARY="List table" CLASS="framing-table">
					    <THEAD>
					        ...
					        <TH NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="selectCell" NOWRAP WIDTH="24%"><B>User Name</B></TH>
					        <TH NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="selectCell" NOWRAP WIDTH="25%"><B>Full Name</B></TH>
					        <TH NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="selectCell" NOWRAP WIDTH="25%"><B>User Type</B></TH>
					        <TH NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="selectCell" NOWRAP WIDTH="25%"><B>Disabled</B></TH>
					        <TH NOWRAP VALIGN="TOP" CLASS="column-head-name" SCOPE="col" id="selectCell" NOWRAP WIDTH="25%"><B>Locked</B></TH>
					...
					%>
					    <TR CLASS="table-row">
						    ...
						    <TD VALIGN="top"  class="collection-table-text">&nbsp;<%=aList[i][5]%></TD>
						    <TD VALIGN="top"  class="collection-table-text">&nbsp;<%=aList[i][6]%></TD>
					    </TR>
					 <%}%>
					<%}%>
					 </TABLE>
